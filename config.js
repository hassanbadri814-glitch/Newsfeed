/* ============================================================
   WAR DESK v19.0 — Nieuwsbronnen configuratie
   ============================================================ */

// Instellingen
const CONFIG = {
  perFeed: 10,              // max artikelen per bron
  autoRefreshMs: 60000,     // 60s auto-refresh
  pauseOnScrollMs: 15000,   // pauzeer bij scroll binnen 15s
  failThreshold: 3,         // 3× falen = tijdelijk uit
  retryAfterMs: 3600000,    // na 1 uur opnieuw proberen
  maxCacheItems: 200,       // offline cache
...
// Bronnen met hogere prioriteit (krijgen hogere score)
const HIGH_PRIORITY = [
...
const KEYWORDS_HIGH = ["killed","dead","deaths","massacre","nuclear","invasion","airstrike","ceasefire","assassinated","declared war"];
const KEYWORDS_MED  = ["explosion","missile","bombing","hostage","shooting","crash","collapse","wounded","injured"];
...
console.log("[WAR DESK] Config geladen —", FEEDS.length, "bronnen");